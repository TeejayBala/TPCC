...
// });
    ...
    // try {
    //     window.ZAB.cookieHandlerUtil.__proto__.setCookie = function(e, i, n) {
    //         console.log("Cookie ---->   ",e,i)
    //         var r = "";
    //         n && ((o = new Date).setTime(o.getTime() + 365 * n * 24 * 60 * 60 * 1e3),
    //         r = ";expires=" + o.toUTCString());
    //         var o, a = Ye.parseURL(ZAB.current_url).domain.replace(/^www\./, "");
    //         y && ((o = new Date).setTime(o.getTime() + 30 * n * 60 * 1e3),
    //         r = ";expires=" + o.toUTCString()),
    //         t.cookie = e + "=" + encodeURIComponent(i) + r + ";path=/;domain=." + a + R.getSamesiteSecureString()
    //     }
    //     // clearInterval(bala);
    // } catch (error) {
    //     console.log(error);
...
// var VERSION = "version",NAME = "name", PREFIX_MOBILE = "Mobile" , 
// SUFFIX_BROWSER = ' Browser',FIREFOX     = 'Firefox',OPERA       = 'Opera';


// regexMacher = function (ua, arrays) {
//     if(!ua || !arrays) return;
//     var result = {};
...
//                                 result[prop[0]] = prop[1].call(this, match);
//                             } else {
...
//                             if (typeof prop[1] === 'function' && !(prop[1].exec && prop[1].test)) {
//                                 // call function (usually string mapper)
//                                 result[prop[0]] = match ? prop[1].call(this, match, prop[2]) : undefined;
//                             } else {
//                                 // sanitize match using given regex
//                                 result[prop[0]] = match ? match.replace(prop[1], prop[2]) : undefined;
//                             }
//                         } else if (prop.length === 4) {
//                                 result[prop[0]] = match ? prop[3].call(this, match.replace(prop[1], prop[2])) : undefined;
//                         }
//                     } else {
//                         result[prop] = match ? match : undefined;
//                     }
//                 }
//             }
...
// regexMacher(navigator.userAgent,b.browser);
// regexMacher(navigator.userAgent,b.device);
// regexMacher(navigator.userAgent,b.os);